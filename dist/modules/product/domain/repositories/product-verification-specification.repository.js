...
exports.ProductVerificationSpecificationRepository = void 0;
const common_1 = require("@nestjs/common");
const repository_abstract_1 = require("../../../../common/database/abstracts/repository.abstract");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
const product_verification_specification_schema_1 = require("../schema/product-verification-specification.schema");
let ProductVerificationSpecificationRepository = class ProductVerificationSpecificationRepository extends repository_abstract_1.AbstractRepository {
    constructor(productVerificationSpecificationModel) {
        super(productVerificationSpecificationModel);
        this.productVerificationSpecificationModel = productVerificationSpecificationModel;
    }
    ...
    async updateProductSpecifications(verificationId, specification) {
        try {
    ...
    async updateProductSpecificationsScore(verificationId, specification) {
        try {
            const operations = specification.flatMap(spec => {
                ...
                if (subspecification && subspecification.length > 0) {
                    const subspecOperations = subspecification.map((subspec) => {
    ...
    async deleteProductSpecificationByVerificationId(verificationId) {
        return this.productVerificationSpecificationModel.deleteMany({ verification_id: verificationId }).exec();
    }
};
exports.ProductVerificationSpecificationRepository = ProductVerificationSpecificationRepository;
exports.ProductVerificationSpecificationRepository = ProductVerificationSpecificationRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(product_verification_specification_schema_1.ProductVerificationSpecification.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], ProductVerificationSpecificationRepository);
//# sourceMappingURL=product-verification-specification.repository.js.map