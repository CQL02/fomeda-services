...
export interface IAuthenticationService {
    ...
    findAllUsersByFilter(filterDto: any): any;
    ...
    approveSupplierReviewStatus(user_id: string, supplierDto: SupplierDto): any;
    rejectSupplierReviewStatus(user_id: string, supplierDto: SupplierDto): any;
