...
let Category = class Category extends schema_abstract_1.SchemaAbstract {
};
...
__decorate([
    ...
    __metadata("design:type", String)
], Category.prototype, "last_updated_by", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        required: true,
        type: Date,
    ...
    __metadata("design:type", Date)
], Category.prototype, "last_updated_on", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        required: true,
        type: Boolean,
...
exports.Category = Category = __decorate([
    (0, mongoose_1.Schema)({ versionKey: false, collection: 'category' })
], Category);
