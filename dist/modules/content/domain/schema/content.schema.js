...
], Content.prototype, "created_on", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        required: true,
        type: String,
    ...
    __metadata("design:type", String)
], Content.prototype, "created_by", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        required: true,
        type: Date,
    ...
    __metadata("design:type", Date)
], Content.prototype, "last_updated_on", void 0);
__decorate([
    (0, mongoose_1.Prop)({
        required: true,
        type: String,
    ...
    __metadata("design:type", String)
], Content.prototype, "last_updated_by", void 0);
exports.Content = Content = __decorate([
    (0, mongoose_1.Schema)({ versionKey: false, collection: 'content' })
], Content);
