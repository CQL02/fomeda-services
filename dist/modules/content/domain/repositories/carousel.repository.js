...
const carousel_schema_1 = require("../schema/carousel.schema");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
let CarouselRepository = class CarouselRepository extends repository_abstract_1.AbstractRepository {
...
exports.CarouselRepository = CarouselRepository = __decorate([
    ...
    __param(0, (0, mongoose_1.InjectModel)(carousel_schema_1.Carousel.name)),
