...
let Sequence = class Sequence extends mongoose_2.Document {
};
...
], Sequence.prototype, "sequence_value", void 0);
exports.Sequence = Sequence = __decorate([
    (0, mongoose_1.Schema)({ versionKey: false, collection: 'sequence' })
], Sequence);
